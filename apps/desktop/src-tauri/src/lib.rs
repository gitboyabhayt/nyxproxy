...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::macros_run,
            commands::playwright_detect_cmd,
            commands::playwright_recordings_list,
            commands::playwright_recording_import,
            commands::playwright_recording_save,
            commands::playwright_recording_delete,
            commands::playwright_parse_cmd,
